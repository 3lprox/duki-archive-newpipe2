        ...
        <div className="mx-auto flex max-w-[1600px] items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 md:gap-4 group cursor-pointer shrink-0" onClick={() => window.location.reload()}>
            ...
            <div className="hidden sm:flex flex-col">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-[7px] font-black text-[#938f99] uppercase tracking-[0.3em]">V4.3 Live</span>
              </div>
            </div>
          </div>
          
          <div className="flex-1 flex items-center gap-3 rounded-[16px] md:rounded-[20px] bg-[#2b2930] px-3 md:px-5 py-2 md:py-3 transition-all focus-within:ring-2 focus-within:ring-[#d0bcff]/30 md:max-w-xl border border-white/5">
            <svg className="h-4 w-4 text-[#938f99]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
            </svg>
            <input
              type="text"
              placeholder="Buscar rastro..."
          ...
          <div className="flex items-center gap-2 md:gap-4">
            <a 
              ...
              className="hidden lg:flex items-center gap-2 bg-[#d0bcff]/10 hover:bg-[#d0bcff]/20 px-4 py-2.5 rounded-[16px] border border-[#d0bcff]/20 transition-all active:scale-95 group"
            >
              <svg className="h-4 w-4 text-[#d0bcff]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M12 4v16m8-8H4" />
              </svg>
              <span className="text-[9px] font-black text-[#d0bcff] uppercase tracking-widest">Sugerir</span>
            </a>
